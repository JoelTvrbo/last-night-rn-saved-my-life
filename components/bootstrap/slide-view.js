    ...
    return (
      <View style={styles.imageContainer}>
        <Animated.View style={[transformNotificationImages, opacityStyle]}>
          ...
          <Image style={styles.imageStyle} source={Images[0]} />
        </Animated.View>
        <Animated.View style={[transformNotificationImages, delayOpacityStyle]}>
          ...
          <Image style={styles.imageStyle} source={Images[1]} />
        </Animated.View>
      </View>
    );
  };
  ...
  render() {
    ...
    return (
      <View style={styles.backgroundContainer}>
        ...
        >
          <Animated.View
            style={[styles.backgroundBlack, backgroundOpacityStyle]}
          />
          <Animated.View
            style={[styles.notififactionStyle, notificationTransformStyle]}
          >
            ...
            <Animated.View style={[styles.infoSubHeading, textTransformStyle]}>
              <Text style={styles.infoSubHeadingStyle}>
                When the most of invited people accept your place suggestion,
